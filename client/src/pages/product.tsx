...
import { getHighResImageProps, generateImageSrcSet, getUpscaledImageStyles } from "@/lib/imageUtils";
...
export default function ProductPage() {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      imageUrl: images[selectedImageIndex]?.url || null,
    } as any);
                  ...
                  return (
                    <button
                      ...
                      className={`relative w-10 h-10 rounded-full border-2 transition-all ${
                        isSelected ? 'border-primary scale-110' : 'border-white/20'
