...
import ralphImg from "@assets/generated_images/ralph_lauren_style_luxury_polo_fashion.png";
import mclarenImg from "@assets/generated_images/mclaren_luxury_automotive_accessories.png";
import gucciImg from "@assets/generated_images/gucci_style_high_fashion_floral_dress.png";
import coachImg from "@assets/generated_images/coach_style_leather_handbag_craftsmanship.png";
...
export default function Home() {
  ...
  useEffect(() => {
    if (products.length > 0) {
      trackViewItemList('homepage_products', 'Latest Treasures', products.slice(0, 8).map(p => ({
        item_id: p.id,
        item_name: p.name,
        item_brand: p.brand,
